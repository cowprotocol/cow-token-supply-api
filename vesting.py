...
_VESTING_MODEL_SIGNATURE = Callable[[int, datetime, timedelta, datetime, Optional[timedelta]], int]
...
def linear_vesting(
    ...
    if interval:
        raise NotImplementedError("Linear Vesting with custom interval haven't been implemted yet.")
    pass
    ...
    vested_portion: float = min(1, seconds_passed_since_start/full_vesting_time_in_seconds)
